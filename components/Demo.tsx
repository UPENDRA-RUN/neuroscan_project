...
const demoSteps = [
  {
    ...
    description:
      "Drag & drop your NIfTI files (.nii/.nii.gz) or select from our sample scans",
    icon: Upload,
    status: "completed",
  ...
  },
  {
    ...
    title: "AI Analysis",
    description:
      "Our advanced algorithms process your scan using deep learning models",
    icon: Brain,
    status: "processing",
  ...
  },
  {
    ...
    description:
      "Comprehensive analysis with 3D visualization and detailed findings",
    icon: BarChart3,
    status: "pending",
      ...
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto text-balance">
            See how our platform transforms neuroimaging analysis in three
            simple steps. Try our interactive demo with real medical imaging
            data.
          </p>
        </motion.div>
              ...
              <motion.div
                ...
                className={`medical-card p-6 cursor-pointer transition-all duration-300 ${
                  selectedStep === step.id
                    ? "ring-2 ring-medical-primary shadow-lg"
                    : ""
                }`}
                ...
                >
                  <div className="border-2 border-dashed border-neural-300 rounded-xl p-8 text-center bg-neural-50/50">
                    ...
                    <p className="text-gray-600 mb-4">
                      Drop your brain scan files here
                    </p>
                    ...
                    {sampleScans.map((scan, index) => (
                      <div
                        ...
                        className={`border rounded-lg p-3 cursor-pointer transition-all ${
                          selectedScan === index
                            ? "border-medical-primary bg-medical-light/20"
                            : "border-gray-200"
                        }`}
                      >
                ...
                >
                  <div className="grid grid-cols-2 gap-4">
                    <div className="bg-success-50 border border-success-200 rounded-lg p-4">
                      <div className="text-success-600 font-semibold mb-1">
                        Overall Health
                      </div>
                    ...
                    <div className="bg-medical-light border border-medical-primary/20 rounded-lg p-4">
                      <div className="text-medical-primary font-semibold mb-1">
                        Brain Volume
                      </div>
                      <div className="text-2xl font-bold text-medical-primary">
                        1,450cc
                      </div>
                      <div className="text-xs text-medical-primary">
                        Within normal range
                      </div>
                    </div>
                  </div>
